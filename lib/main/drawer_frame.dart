    ...
    return Column(children: <Widget>[
      Container(
          ...
          child: Stack(children: <Widget>[
            ConstrainedBox(child: Image.asset(AVATAR_URI, fit: BoxFit.cover), constraints: BoxConstraints.expand()),
            ClipRect(
                child: BackdropFilter(
                    filter: ImageFilter.blur(sigmaX: BLUR_SIGMA_X, sigmaY: BLUR_SIGMA_Y),
            ...
            Center(
                child: Container(
                    ...
                    child: CircleAvatar(radius: 30, backgroundImage: AssetImage(AVATAR_URI)))),
            Container(
                margin: const EdgeInsets.only(left: 8, bottom: 8),
                alignment: Alignment.bottomLeft,
                child: Text("williscao", style: TextStyle(color: Colors.white)))
          ])),
      InkWell(onTap: _onHomeTap, child: ListTile(leading: Icon(Icons.home), title: Text("Home"))),
      InkWell(onTap: _onMessageTap, child: ListTile(leading: Icon(Icons.message), title: Text("Message"))),
      InkWell(onTap: _onPhotoTap, child: ListTile(leading: Icon(Icons.photo), title: Text("Photo")))
    ]);
  }
