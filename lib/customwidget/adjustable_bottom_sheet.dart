...
/// [Scaffold.bottomSheet], and a modal bottom sheet with [showAdjustableModalBottomSheet].
///
/// See also:
///
///  * [showBottomSheet] and [ScaffoldState.showBottomSheet], for showing
///    non-modal "persistent" bottom sheets.
///  * [showAdjustableModalBottomSheet], which can be used to display a modal bottom
///    sheet.
...
class BottomSheet extends StatefulWidget {
  ...
  /// [showAdjustableModalBottomSheet], for modal bottom sheets.
  const BottomSheet({
    Key key,
...
class _ModalBottomSheetLayout extends SingleChildLayoutDelegate {
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    return BoxConstraints(
      ...
      minHeight: 0.0,
      maxHeight: constraints.maxHeight * 4.0 / 5.0,
    );
  }
...
Future<T> showAdjustableModalBottomSheet<T>({
...
/// [showAdjustableModalBottomSheet] function.
///
